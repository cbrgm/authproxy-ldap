...
if [ -z $SAN ]
  then echo "Set SAN with a DNS or IP(e.g. export SAN=IP.1:127.0.0.1,IP.2:192.168.178.2)."
  exit 1
fi

echo "Creating Certificate Authority, authproxy cert/key, and client cert/key..."
